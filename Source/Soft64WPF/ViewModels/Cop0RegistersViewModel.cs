...
using Cop0Regs = Soft64WPF.ViewModels.Cop0RegistersViewModel;
...
namespace Soft64WPF.ViewModels
{
    public sealed class Cop0RegistersViewModel : QuickDependencyObject
    {
        ...
        {
            SetValue(CausePK, new CauseVM());
            SetValue(StatusPK, new StatusVM());
        ...
        #region DP - Cause
        private static readonly DependencyPropertyKey CausePK = RegDPKey<Cop0Regs, CauseVM>("Cause");
        public static readonly DependencyProperty CauseProperty = CausePK.DependencyProperty;
        public CauseVM Cause => GetValue(CauseProperty);
        #endregion

        #region DP - Status
        private static readonly DependencyPropertyKey StatusPK = RegDPKey<Cop0Regs, StatusVM>("Status");
        public static readonly DependencyProperty StatusProperty = StatusPK.DependencyProperty;
        public StatusVM Status => GetValue(StatusProperty);
        #endregion

        #region DP - Count
        private static readonly DependencyPropertyKey CountPK = RegDPKey<Cop0Regs, Register32Value>("Count");
        ...
        #region DP - Compare
        private static readonly DependencyPropertyKey ComparePK = RegDPKey<Cop0Regs, Register32Value>("Compare");
        ...
        private static readonly DependencyPropertyKey BadVAddressPK = RegDPKey<Cop0Regs, Register64Value>("BadVAddress");
        ...
        #region DP - Entry Hi
        private static readonly DependencyPropertyKey EntryHiPK = RegDPKey<Cop0Regs, Register64Value>("EntryHi");
        ...
        private static readonly DependencyPropertyKey EntryLo0PK = RegDPKey<Cop0Regs, Register64Value>("EntryLo0");
        ...
        private static readonly DependencyPropertyKey EntryLo1PK = RegDPKey<Cop0Regs, Register64Value>("EntryLo1");
        ...
        #region DP - Index
        private static readonly DependencyPropertyKey IndexPK = RegDPKey<Cop0Regs, Register64Value>("Index");
        ...
        #region DP - PageMask
        private static readonly DependencyPropertyKey PageMaskPK = RegDPKey<Cop0Regs, Register64Value>("PageMask");
        ...
        #region DP - Random
        private static readonly DependencyPropertyKey RandomPK = RegDPKey<Cop0Regs, Register64Value>("Random");
        ...
        #region DP - Wired
        private static readonly DependencyPropertyKey WiredPK = RegDPKey<Cop0Regs, Register64Value>("Wired");
        ...
        #region DP - Context
        private static readonly DependencyPropertyKey ContextPK = RegDPKey<Cop0Regs, Register64Value>("Context");
        ...
        #region DP - EPC
        private static readonly DependencyPropertyKey EPCPK = RegDPKey<Cop0Regs, Register64Value>("EPC");
        ...
        #region DP - PRId
        private static readonly DependencyPropertyKey PRIdPK = RegDPKey<Cop0Regs, Register64Value>("PRId");
        ...
        #region DP - Config
        private static readonly DependencyPropertyKey ConfigPK = RegDPKey<Cop0Regs, Register64Value>("Config");
        ...
        #region DP - LLAddr
        private static readonly DependencyPropertyKey LLAddrPK = RegDPKey<Cop0Regs, Register64Value>("LLAddr");
        ...
        #region DP - WatchLo
        private static readonly DependencyPropertyKey WatchLoPK = RegDPKey<Cop0Regs, Register64Value>("WatchLo");
        ...
        #region DP - WatchHi
        private static readonly DependencyPropertyKey WatchHiPK = RegDPKey<Cop0Regs, Register64Value>("WatchHi");
        ...
        #region DP - XContext
        private static readonly DependencyPropertyKey XContextPK = RegDPKey<Cop0Regs, Register64Value>("XContext");
        ...
        #region DP - ECC
        private static readonly DependencyPropertyKey ECCPK = RegDPKey<Cop0Regs, Register64Value>("ECC");
        ...
        #region DP - CacheErr
        private static readonly DependencyPropertyKey CacheErrPK = RegDPKey<Cop0Regs, Register64Value>("CacheErr");
        ...
        #region DP - TagLo
        private static readonly DependencyPropertyKey TagLoPK = RegDPKey<Cop0Regs, Register64Value>("TagLo");
        ...
        #region DP - TagHi
        private static readonly DependencyPropertyKey TagHiPK = RegDPKey<Cop0Regs, Register64Value>("TagHi");
        ...
        #region DP - ErrorEPC
        private static readonly DependencyPropertyKey ErrorEPCPK = RegDPKey<Cop0Regs, Register64Value>("ErrorEPC");
