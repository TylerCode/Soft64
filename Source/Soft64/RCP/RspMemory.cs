...
//        private RegistersMemorySection m_RspRegisterHeap;
//        private Boolean m_Disposed;

//        public RspMemory()
//        {
//            m_SPRam = new MemorySection(0x1000 * 2, 0x04000000);
//            m_RspRegisterHeap = new RegistersMemorySection(1024 ^ 2, 0x04010000);
//            RegMemoryAddress = new RspRegisterAddressMode(m_RspRegisterHeap, 4 * 0);
//            RegDramAddress = new RspRegisterAddress(m_RspRegisterHeap, 4 * 1);
//            RegReadLength = new RspRegisterLength(m_RspRegisterHeap, 4 * 2);
//            RegWriteLength = new RspRegisterLength(m_RspRegisterHeap, 4 * 3);
//            RegStatusW = new RspRegisterStatusW(m_RspRegisterHeap, 4 * 4);
//        }
