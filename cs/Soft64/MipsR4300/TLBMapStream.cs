...
namespace Soft64.MipsR4300
{
    internal sealed class TLBMapStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            Machine.Current.Memory.Position = translatedAddress - 0x80000000;
            Machine.Current.Memory.Read(buffer, 0, buffer.Length);
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            Machine.Current.Memory.Position = translatedAddress - 0x80000000;
            Machine.Current.Memory.Write(buffer, 0, buffer.Length);
        }
    }
}