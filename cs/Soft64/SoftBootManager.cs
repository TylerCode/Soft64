...
namespace Soft64
{
    ...
    public static class SoftBootManager
    {
        ...
        private static void PifHleCopyBootRom()
        {
            ...
            CopyBootRom(Machine.Current.Memory, Machine.Current.DeviceRCP.Interface_Parallel.InsertedCartridge.RomImage.RomStream);
        }

        private static void CopyBootRom(Stream outStream, Stream inStream)
        {
            inStream.Position = CartRom.HeaderSize;
            Byte[] buffer = new Byte[BootRom.Size];
